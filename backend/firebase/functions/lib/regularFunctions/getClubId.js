...
exports.getClubId = functions.region("europe-west1").https.onCall(async (data, context) => {
    ...
    await utils_1.checkPrerequirements(data, context, ["identifier"], false);
    const path = utils_1.getClubComponent(data);
...
//# sourceMappingURL=getClubId.js.map