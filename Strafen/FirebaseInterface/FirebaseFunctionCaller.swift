...
struct FirebaseFunctionCaller {
    ...
    func call<CallType>(_ item: CallType, level: FirebaseDatabaseLevel = .defaultValue) -> Promise<HTTPSCallableResult> where CallType: FirebaseFunctionCallable {
    ...
    func call<CallType>(_ item: CallType, level: FirebaseDatabaseLevel = .defaultValue) -> Promise<CallType.CallResult> where CallType: FirebaseFunctionCallable & FirebaseFunctionCallResult {
