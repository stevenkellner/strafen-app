...
struct SingleButton: View {
    ...
    /// Cancel button
    static let cancel = SingleButton(String(localized: "cancel-button-text", comment: "Text of cancel button."))
        .fontSize(27)
        .leftSymbol(name: "chevron.left.2")
        .leftColor(.customRed)

    /// Confirm button
    static let confirm = SingleButton(String(localized: "confirm-button-text", comment: "Text of confirm button."))
        .fontSize(27)
        .rightSymbol(name: "checkmark.seal")
        .rightColor(.customGreen)

    /// Continue button
    static let `continue` = SingleButton(String(localized: "continue-button-text", comment: "Text of continue button."))
        .fontSize(27)
